...
private EmployeeRepo repo;
	...
	public void run(String... args) throws Exception {
		...
		//repo.findByEmpDept("QA").forEach(System.out::println);
		repo.findByEmpId(102).forEach(System.out::println);
		repo.findByEmpName("Vandu").forEach(System.out::println);
	//	System.out.println(repo.findById(101)); it is working fine it will display single record 
